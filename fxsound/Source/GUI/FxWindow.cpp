...
void FxWindow::TitleBar::paint(Graphics& g)
{
    ...
    title_.setFont(font);
    title_.setSize((int)(GlyphArrangement::getStringWidth(font, TRANS(name_)) * 2), (int)font.getHeight());
...
void FxWindow::TitleBar::updateLogo()
{
	...
	else
	{
		...
		title_.setSize((int)(GlyphArrangement::getStringWidth(font, name_) * 2), (int)font.getHeight());
